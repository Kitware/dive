"""
Debug cli includes extra tools that may involve heavy requirements
that should not be shipped with the regular installation or installed in CI

Debug cli requires `pip install -e .[debug]` requirements from setuptools
"""
import click
...
def make_debug_cli(cli: click.Group):
