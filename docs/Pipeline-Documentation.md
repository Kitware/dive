...
* All canned pipelines are available on web and deskop.
* Some training configurations are only available on desktop

## Help me choose

Contact our team if you need help choosing the right data analysis strategy.  Please upload some sample data to viame.kitware.com to allow us to better assis you.
...
| <pre>scallop and flatfish left</pre>  | detector for benthic images |
| <pre>scallop netharn</pre>  | deep learning detector for benthic images |
| <pre>scallop netharn left</pre>  | deep learning detector for benthic images |
| <pre>sea lion multi class</pre>  | detects bulls, cows, pups, etc |
| <pre>sea lion single class</pre>  | detector |
| <pre>sefsc bw 18cls</pre>  | black-and-white 18-class fish detector (oldest, v1) |
| <pre>sefsc bw 108cls v2</pre>  | black-and-white 108-class fish detector (updated, v2) |
...
| <pre>generic</pre>  | generic object tracker for bootstrapping groundtruth annotations |
...
| [detector_netharn_cfrnn](https://github.com/VIAME/VIAME/blob/master/configs/pipelines/train_detector_netharn_cfrnn.viame_csv.conf) | desktop | |
...
| [object_classifier_netharn_resnet](https://github.com/VIAME/VIAME/blob/master/configs/pipelines/train_object_classifier_netharn_resnet.viame_csv.conf) | desktop | |
| yolo | desktop | can train, but resulting model **is not runnable with desktop** yet |
