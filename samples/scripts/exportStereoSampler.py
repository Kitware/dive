...
python samples/scripts/exportStereoSampler.py --check
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=Path, default=Path(__file__).resolve().parents[2] / "client/public/models/stereo_sample.onnx")
