...
Run: python samples/scripts/exportSamPostprocess.py --check
...
def build_model():
    ...
    model = h.make_model(graph, producer_name="DIVE", opset_imports=[h.make_opsetid("", 18)], ir_version=9)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=Path, default=Path(__file__).resolve().parents[2] / "client/public/models/sam_postprocess.onnx")
